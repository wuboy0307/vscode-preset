...
- Run the command `Apply Recommended Workspace Settings` from the Command Palette.
- The extension will prompt before writing to the workspace settings file (`.vscode/settings.json`).
- There is also a preview option which opens the JSON that would be applied.
